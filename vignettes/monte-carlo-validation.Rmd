...
$mc_j = \gamma_0 + \gamma_w w_j + \omega_j$ with $\omega \sim N(0, 0.2)$.

Results confirm that gamma (supply parameters) are recovered alongside
the demand parameters. The cost shifter coefficient $\gamma_w = 1.5$
is correctly signed in the majority of replications.

## Case 5: CI Coverage --- 500 Replications

We check whether 95% confidence intervals $[\hat\beta \pm 1.96 \cdot SE]$
cover the true value at the nominal rate.
...
finite-sample bias of BLP with standard instruments. Two approaches
to improve coverage:
