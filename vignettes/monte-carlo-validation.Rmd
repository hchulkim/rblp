...
smaller sigma matrix will cause the simulation to fail before estimation.
This case should therefore be treated as a specification check rather
than as a headline benchmark.
