...
The problem has `r rc_problem$K2` random coefficients (intercept, prices, sugar, mushy), so with `size = 3` Gauss-Hermite nodes per dimension, we get $3^4 = 81$ integration points per market.
